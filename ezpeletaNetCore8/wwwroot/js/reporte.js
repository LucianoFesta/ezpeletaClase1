        ...
        success: function(result) {
            if(result){
                $.each(result, function(index, ejercicios){
                    console.log(ejercicios.ejerciciosLugar)
                    $('#tbody-reporte').append(`
                        <tr class="trEjercicio">
                            <td class="tbody">${ejercicios.tipoEjercicio}</td>
                            <td class="tbody"></td>
                            <td class="tbody"></td>
                            <td class="tbody"></td>
                            <td class="tbody"></td>
                    ...
                    `)
                    $.each(ejercicios.ejerciciosLugar, function(i, ejerciciosLugar){
                        $('#tbody-reporte').append(`
                            <tr class="trEjercicio">
                                <td class="tbody"></td>
                                <td class="tbody">${ejerciciosLugar.lugar}</td>
                                <td class="tbody"></td>
                                <td class="tbody"></td>
                                <td class="tbody"></td>
                                <td class="tbody"></td>
                        ...
                        $.each(ejerciciosLugar.ejercicios, function(i, ejercicio){
