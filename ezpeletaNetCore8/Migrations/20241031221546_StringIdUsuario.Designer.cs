...
namespace ezpeletaNetCore8.Migrations
{
    ...
    [Migration("20241031221546_StringIdUsuario")]
    partial class StringIdUsuario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ezpeletaNetCore8.Models.EventoDeportivo", b =>
                {
            ...
            modelBuilder.Entity("ezpeletaNetCore8.Models.Lugar", b =>
                {
                    b.Property<int>("LugarID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ezpeletaNetCore8.Models.Persona", b =>
                {
                    b.Property<int>("PersonaID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ezpeletaNetCore8.Models.EjercicioFisico", b =>
                {
                    b.HasOne("ezpeletaNetCore8.Models.EventoDeportivo", "EventoDeportivo")
                        .WithMany("EjercicioFisicos")
                        .HasForeignKey("EventoDeportivoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ezpeletaNetCore8.Models.Lugar", "Lugar")
                        .WithMany("EjeciciosFisicos")
                        .HasForeignKey("LugarID");

                    b.HasOne("ezpeletaNetCore8.Models.Persona", "Persona")
